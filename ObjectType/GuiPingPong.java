...
public class GuiPingPong extends Ellipse2D.Double implements GameObject{
	...
	public GuiPingPong(double x, double y){
		this(x, y, DEFAULT_RADIUS);
	}
	
	public GuiPingPong(double x, double y, Color color){
		this(x, y, DEFAULT_RADIUS, color);
	}
	
	public GuiPingPong(double x, double y, double radius){
		this(x, y, radius, DEFAULT_COLOR);
	}
	
	public GuiPingPong(double x, double y, double radius, Color color){
	...
	public GameObject copy() {
		return new GuiPingPong(getLocation().getX(), getLocation().getY(), radius, color);
	}
}
